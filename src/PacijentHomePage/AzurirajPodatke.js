export default function AzurirajPodatke(){
    return (
      ...
      <form className="items-center bg-gradient-to-r from-blue-300 to-blue-900 w-full h-full font-black text-black flex flex-col text-sm">
        ...
        <div className="mb-6 text-center w-5/6">
          <label for="pwd" className="text-white">Nova lozinka :</label>
        ...
        <div className="mb-6 text-center w-5/6">
          <label for="alergeni" className="text-white">Alergeni:</label>
          <input className="h-6 shadow appearance-none border rounded w-full py-1 px-3 text-grey-darker" type="text" name="alergeni" id='alergeni'placeholder="unesite alergene"/>
        </div>
